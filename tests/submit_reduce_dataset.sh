...
which python3
python3 $pythonfile -f /projects/0/einf1300/saltis-wp3-1/C_Work/05_RMD_2019/computations/${run_name}/${run_name}${run_id}/${filebase}_000*_map.nc -o $outfile -m $max_mem -n 8 -c time=100 -k 'mesh2d_sa1' 'mesh2d_node_z' 'mesh2d_ucx' 'mesh2d_ucy' 'mesh2d_ucz' 'mesh2d_vol1' 'mesh2d_vicwwu' 'mesh2d_tem1' 'mesh2d_face_nodes' 'mesh2d_edge_nodes' 'mesh2d' -e '{"mesh2d_face_nodes": {"dtype": "float32"}, "mesh2d_edge_nodes": {"dtype": "float64"}, "mesh2d_nNodes": {"dtype":"int32"}, "mesh2d_nFaces": {"dtype":"int32"}, "mesh2d_nEdges": {"dtype":"int32"}, "mesh2d_flowelem_zcc": {"dtype":"float32"}, "mesh2d_flowelem_zw": {"dtype":"float32"}, "mesh2d_face_x": {"dtype":"float32"}, "mesh2d_face_y": {"dtype":"float32"}, "mesh2d_edge_x": {"dtype":"float32"}, "mesh2d_edge_y": {"dtype":"float32"}, "mesh2d_sa1": {"dtype":"float32"}, "mesh2d_node_x": {"dtype":"float32"}, "mesh2d_node_y": {"dtype":"float32"}, "mesh2d_node_z": {"dtype":"float32"}, "mesh2d_ucx": {"dtype":"float32"}, "mesh2d_ucy": {"dtype":"float32"}, "mesh2d_ucz": {"dtype":"float32"}, "mesh2d_vol1": {"dtype":"float32"}, "mesh2d_vicwwu": {"dtype":"float32"}, "mesh2d_tem1":{"dtype":"float32"}}' > ~/%x.%j.pro